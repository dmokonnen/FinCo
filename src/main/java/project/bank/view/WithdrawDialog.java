...
import project.bank.model.WithdrawCommand;
...
public class WithdrawDialog extends JDialog {
	...
	public WithdrawDialog(BankFrm parent, IAccount account, IAccountManager accountManager) {
		super(parent);
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
		IAccountCommand command = new WithdrawCommand(account, Double.parseDouble(JTextField_AMT.getText()));
