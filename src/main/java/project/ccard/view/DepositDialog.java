...
public class DepositDialog extends javax.swing.JDialog {
	...
	public DepositDialog(CardFrm parent, IAccount account, IAccountManager accountManager) {
		super(parent);
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
		IAccountCommand depositCommand = new DepositCommand(account, Double.parseDouble(JTextField_Deposit.getText()));
		accountManager.executeCommand(depositCommand);
        dispose();
	}
