...
public class AddAccountDialog extends JDialog {
	...
	public AddAccountDialog(MainWindow parent, List<ICustomer> customers) {
		...
		JTextField_NAME.setBounds(84,JLabel1.getY(),156,20);
		getContentPane().add(JTextField_CT);
		JTextField_CT.setBounds(84,JLabel3.getY(),156,20);
		getContentPane().add(JTextField_ST);
		JTextField_ST.setBounds(84,JLabel4.getY(),156,20);
		getContentPane().add(JTextField_STR);
		JTextField_STR.setBounds(84,JLabel2.getY(),156,20);
		getContentPane().add(JTextField_ZIP);
		JTextField_ZIP.setBounds(84,JLabel5.getY(),156,20);
		getContentPane().add(JTextField_EM);
		JTextField_EM.setBounds(84,JLabel6.getY(),156,20);
