...
import project.bank.JDialog_AddCompAcc;
...
public class AddOrganizationAccountDialog extends javax.swing.JDialog {
	private MainWindow parentframe;

	public AddOrganizationAccountDialog(MainWindow parent)
	{
		super(parent);
		parentframe=parent;
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
		...
		parentframe.setAddress(
				new Address(JTextField_ST.getText(), JTextField_CT.getText(),
						JTextField_STR.getText(), JTextField_ZIP.getText()));
		parentframe.newAccount = true;

		// TODO: Create Company Account Here
